...
public:
     ...
     */
    virtual std::pair<ControlStatus, std::vector<AudioConnection>> get_all_input_connections() const override;
     ...
     * @return std::vector<AudioConnection>
     */
    virtual std::pair<ControlStatus, std::vector<AudioConnection>> get_all_output_connections() const override;
     ...
     * @return std::vector<AudioConnection>
     */
    virtual std::pair<ControlStatus, std::vector<AudioConnection>> get_input_connections_for_track(int track_id) const override;
     ...
     * @return std::vector<AudioConnection>
     */
    virtual std::pair<ControlStatus, std::vector<AudioConnection>> get_output_connections_for_track(int track_id) const override;
     ...
     */
    virtual ControlStatus connect_input_channel_to_track(int track_id, int track_channel, int input_channel) override;
     ...
     * @return ControlStatus
     */
    virtual ControlStatus connect_output_channel_from_track(int track_id, int track_channel, int output_channel) override;
     ...
     * @return ControlStatus
     */
    virtual ControlStatus disconnect_input(int track_id, int track_channel, int input_channel) override;
     ...
     * @return ControlStatus
     */
    virtual ControlStatus disconnect_output(int track_id, int track_channel, int output_channel) override;
     ...
     * @return ControlStatus
     */
    virtual ControlStatus disconnect_all_inputs_from_track(int track_id) override;
     ...
     * @return ControlStatus
     */
    virtual ControlStatus disconnect_all_outputs_from_track(int track_id) override;
